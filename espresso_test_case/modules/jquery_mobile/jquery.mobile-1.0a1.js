...
// espresso_test_case whether a CSS media type or query applies
$.media = (function() {
...
// reside (so you can espresso_test_case it yourself).
// 
...
// 1.1   - (1/21/2010) Incorporated document.documentMode espresso_test_case to fix IE8 bug
...
(function($,window,undefined){
  ...
  var str_hashchange = 'hashchange',
    ...
    // though the event isn't supported, so also espresso_test_case document.documentMode.
