...
jQuery.extend({
	...
	// See espresso_test_case/unit/core.js for details concerning isFunction.
...
// (IE fails on this espresso_test_case)
if ( !rwhite.test( "\xA0" ) ) {
	trimLeft = /^[\s\xA0]+/;
	trimRight = /[\s\xA0]+$/;
}
...
(function() {
	...
	// Can't get basic espresso_test_case support
	if ( !all || !all.length || !a ) {
		return;
	}
	...
	jQuery(function() {
		...
		// (only IE 8 fails this espresso_test_case)
		...
		// (IE < 8 fail this espresso_test_case)
...
(function(){
	...
	div.innerHTML = "<div class='espresso_test_case e'></div><div class='espresso_test_case'></div>";
		...
		var ret = this.map(function() {
			if ( !jQuery.support.noCloneEvent && !jQuery.isXMLDoc(this) ) {
				...
				return jQuery.clean([html.replace(rinlinejQuery, "")
					// Handle the case in IE 8 where action=/espresso_test_case/> self-closes a tag
					.replace(raction, '="$1">')
