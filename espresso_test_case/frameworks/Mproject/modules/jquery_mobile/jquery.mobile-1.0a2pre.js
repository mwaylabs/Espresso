...
$.widget( "mobile.slider", $.mobile.widget, {
	...
	_create: function(){	
		var control = this.element,
			...
			cType = control[0].name.toLowerCase(),
...
jQuery.widget( "mobile.listview", jQuery.mobile.widget, {
	...
	_itemApply: function( $list, item ) {
		...
		if ( jQuery.support.cssPseudoElement || !jQuery.name( item[0], "ol" ) ) {
			return;
		}
	},
	...
	refresh: function( create ) {
		...
		var o = this.options,
			...
			li = $list.children( "li" ),
			counter = jQuery.support.cssPseudoElement || !jQuery.name( $list[0], "ol" ) ? 0 : 1;
